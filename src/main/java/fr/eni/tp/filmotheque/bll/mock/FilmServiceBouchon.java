...
@Service
//@Profile("dev")
public abstract class FilmServiceBouchon implements FilmService {
	...
	public void simulationCoucheDALetDB() {
		...
		Film leMondePerdu = new Film(indexFilms++, "Le Monde Perdu", 1997, 120, "Suite de Jurassic Park, 4 ans après");
		...
		Film jurassicWorld = new Film(indexFilms++, "Jurassic World", 2015, 120, "Suite de Jurassic Park");
